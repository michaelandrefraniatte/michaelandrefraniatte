...
**• Prices:** Possible negotiation directly with author, otherwise the prices are as following... $1 million per work and per user, agreed upon with consent, otherwise $1 billion with only private use, otherwise $1 trillion with unfair use, like if you share or sell or publish or supplant or appropriate for you or dispossess author.  
