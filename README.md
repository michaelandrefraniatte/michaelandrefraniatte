...
Owning: All works from scratch of the owner, near 100% of published works.
...
Consequences of Use: Fail of the contract imply fail of owner fight. Who not accepting the contract but still using is contributing to a worst real nightmare than just peck without any agreement. The owner can't imagine all the road traveled destroyed and ruined, but redone. The owner is inextricable, and the failures will never be forgiven, nor forgotten. It's already the case, and it's too late. It's totally gangrened, the owner fight was avorted, telling who why what is no longer useful. The works of the owner returns by rights to another reality, nobody is or will be part of, nobody belonging to this one. This reality is random, not where go works of the owner, not like the owner which have nothing in common with, where nobody care, just for fill the throat. In other terms, any use is criminal.
