...
Consequences of Use: Who not accepting the contract but still using is contributing to a worst real nightmare than just peck without any agreement. The owner can't imagine all the road traveled destroyed and ruined, but redone, considering owner was alone to rule the game while nobody could do and would care about the lost. The reality is random, where nobody care, just for fill the throat and take for a fool. The works of the owner returns by rights to another reality, nobody is part of. In other terms, any use is criminal and disrespectful.
